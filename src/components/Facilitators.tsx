...
const facilitators = [
  {
    name: "Мустафина Анна Ильгизаровна",
    role: "Врач акушер-гинеколог · 28 лет стажа",
    description:
      "Индивидуальное акушерское сопровождение в естественных родах. Перинатальный психолог, психолог ЭОТ. Член общественной организации «Врачи за жизнь», основатель НКО «Университет семьи». Автор книги «Счастье быть женщиной».",
  ...
  {
    name: "Куликова Наталья Васильевна",
    role: "Практикующий психолог ЭОТ",
    description:
      "Действительный член Профессиональной психологической лиги (ППЛ). Сертифицированная ведущая женских кругов и авторской игры «7 шагов к стройности». Специалист по Эмоционально-образной терапии.",
